---
title: "Actividad 3. Aprendizaje Automatico"
output:
...
```{r warning=FALSE}
df<- read_excel("C:/Users/aalma/OneDrive/TEC/Carrera/5to semestre/1er Parcial/Algoritmos y análisis de datos (Gpo 6)/Tareas/Actividad 3/IXIC.xlsx")
