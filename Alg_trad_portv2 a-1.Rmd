...
```{r warning=FALSE}
df<- read.xlsx("C:/Users/aalma/OneDrive/TEC/Carrera/5to semestre/1er Parcial/Algoritmos y análisis de datos (Gpo 6)/Trabajos en clase/Trabajo 20210831/Data.xlsx")
```
